...
function BarGraph(ctx) {
	...
	/*	ctx.fillStyle = "#333";
        ...
        gradient.addColorStop(1, "#ffffff");
			*/
			...
			ctx.fillStyle = that.colors[i % that.colors.length]; //todo: logica de cambio de color aqui.
			//ctx.fillStyle = that.colors[0]; //todo: logica de cambio de color aqui.
  ...
  this.offBars = function (arr) {
    ...
    console.log("Se ternmina la limpieza");
  };
